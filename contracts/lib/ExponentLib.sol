...
library ExponentLib {
     ...
     */
    function powerE(int256 _x) public pure returns (int256) {
    ...
    function powerAny(int256 a, int256 b) public pure returns (int256) {
        return powerE(FixidityLib.multiply(LogarithmLib.ln(a), b));
    }

    function rootAny(int256 a, int256 b) public pure returns (int256) {
        return powerAny(a, FixidityLib.reciprocal(b));
    }

    function rootN(int256 a, uint8 n) public pure returns (int256) {
        return powerE(FixidityLib.divide(LogarithmLib.ln(a), FixidityLib.fixed1() * n));
    }

    // solium-disable-next-line mixedcase
    function round_off(int256 _v, uint8 digits) public pure returns (int256) {
    ...
    // solium-disable-next-line mixedcase
    function trunc_digits(int256 v, uint8 digits) public pure returns (int256) {
