...
describe('AavePodPutBuilder', function () {
  let OptionBuilder
  ...
  it('Should create a new AavePodPut Option correctly and not revert', async function () {
    const optionData = {
      name: 'Pods Put WETH:aDAI 1200 2021-06-11',
      symbol: 'PodWETH:aDAI',
