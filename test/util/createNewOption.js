...
module.exports = async function createNewOption (deployerAddress, factoryContract, name, symbol, underlyingAsset, strikeAsset, strikePrice, expiration, exerciseWindowSize) {
  let podPut
